...
> This documentation is written in [Markdown](https://bitbucket.org/tutorials/markdowndemo/src) format and change logs follow this [set of guidelines](http://keepachangelog.com/).
