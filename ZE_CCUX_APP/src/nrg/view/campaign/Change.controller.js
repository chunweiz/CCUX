...
sap.ui.define(
    ...
    function (CoreController) {
        ...
        Controller.prototype.onBeforeRendering = function () {
            ...
            this.getView().setModel(new sap.ui.model.json.JSONModel(), "ChangeData");
            this.getView().getModel("ChangeData").setProperty("/priceData", aPriceData);
            this.getView().getModel("ChangeData").setProperty("/campaignData", aCampaignData);
