...
call grunt --build=module --moduleName=nrg.module.app.header --moduleFolder=ZE_CCUX_MOD_APP
call grunt --build=module --moduleName=nrg.module.app.footer --moduleFolder=ZE_CCUX_MOD_APP
call grunt --build=module --moduleName=nrg.module.app.main --moduleFolder=ZE_CCUX_MOD_APP
